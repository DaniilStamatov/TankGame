...
static float quadVertices[] = {
    ...
    -0.5f, -0.5f, 0.0f, 0.0f, 0.0f, // 0: левый-нижний
    0.5f,  -0.5f, 0.0f, 1.0f, 0.0f, // 1: правый-нижний
    0.5f,  0.5f,  0.0f, 1.0f, 1.0f, // 2: правый-верхний
    -0.5f, 0.5f,  0.0f, 0.0f, 1.0f  // 3: левый-верхний
};

static unsigned int quadIndices[] = {0, 1, 2, 2, 3, 0};
...
void Renderer2D::Init() {
  ...
  m_ebo = IndexBuffer::Create(quadIndices,
                              sizeof(quadIndices) / sizeof(unsigned int));
  m_vao->SetIndexBuffer(m_ebo);
}

void Renderer2D::DrawQuad(const glm::mat4 &viewProj, const glm::mat4 &transform,
